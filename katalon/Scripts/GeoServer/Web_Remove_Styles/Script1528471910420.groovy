...
WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Styles/input_tablelistContaineritems2'))

WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Styles/input_tablelistContaineritems3'))

WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Styles/a_Removed selected style(s)'))

WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Styles/a_OK'))
