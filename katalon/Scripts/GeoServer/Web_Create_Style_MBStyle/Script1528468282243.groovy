...
WebUI.setText(findTestObject('SuiteQAAutomation/Page_GeoServer New style/input_contextpanelname'), 'QAMBStyle')
...
WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer New style/span_select2-selection__arrow_2'))

WebUI.setText(findTestObject('SuiteQAAutomation/Page_GeoServer New style/input_select2-search__field'), 'MBStyle')
