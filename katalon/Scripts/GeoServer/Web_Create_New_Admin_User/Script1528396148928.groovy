...
WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Users Groups and Rol/a_Add new user'))

WebUI.setText(findTestObject('SuiteQAAutomation/Page_GeoServer Add a new user/input_username'), 'QAAdmin')

WebUI.setText(findTestObject('SuiteQAAutomation/Page_GeoServer Add a new user/input_password'), 'QA')

WebUI.setText(findTestObject('SuiteQAAutomation/Page_GeoServer Add a new user/input_confirmPassword'), 'QA')

WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Add a new user/a_Save'))
