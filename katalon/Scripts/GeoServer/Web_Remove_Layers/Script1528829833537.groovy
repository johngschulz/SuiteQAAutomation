...
WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Layers/input_tablelistContaineritems3'))

WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Layers/input_tablelistContaineritems4'))

WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Layers/a_Remove selected layers'))

WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Layers/a_OK'))
