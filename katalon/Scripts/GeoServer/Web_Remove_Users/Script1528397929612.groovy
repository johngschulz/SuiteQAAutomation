...
WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Users Groups and Rol/input_services0paneluserstable'))

WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Users Groups and Rol/input_services0paneluserstable_1'))

WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Users Groups and Rol/a_Remove Selected0'))

WebUI.click(findTestObject('SuiteQAAutomation/Page_GeoServer Users Groups and Rol/a_OK0'))
