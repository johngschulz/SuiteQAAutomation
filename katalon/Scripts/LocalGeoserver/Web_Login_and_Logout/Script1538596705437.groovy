...
WebUI.click(findTestObject('Web/GeoServer/Page_GeoServer Welcome/a_GeoServer 2.13.0'))

WebUI.click(findTestObject('Web/GeoServer/Page_GeoServer Welcome/span_Logout'))
