...
WebUI.click(findTestObject('Web/GeoServer/Page_GeoServer Users Groups and Rol/input_services0paneluserstable'))

WebUI.click(findTestObject('Web/GeoServer/Page_GeoServer Users Groups and Rol/input_services0paneluserstable_1'))
