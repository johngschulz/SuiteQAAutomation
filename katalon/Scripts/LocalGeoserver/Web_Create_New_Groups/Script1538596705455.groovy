...
WebUI.click(findTestObject('Web/GeoServer/Page_GeoServer Users Groups and Rol/a_Add new group'))

WebUI.setText(findTestObject('Web/GeoServer/Page_GeoServer Add a new group/input_groupname'), 'QAPub_lg')

WebUI.click(findTestObject('Web/GeoServer/Page_GeoServer Add a new group/a_Save'))

WebUI.click(findTestObject('Web/GeoServer/Page_GeoServer Users Groups and Rol/a_Add new group_1'))

WebUI.setText(findTestObject('Web/GeoServer/Page_GeoServer Add a new group/input_groupname'), 'QAPriv_lg')
