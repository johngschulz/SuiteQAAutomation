...
WebUI.setText(findTestObject('Web/GeoServer/Page_GeoServer Users Groups and Rol/input_username'), 'admin')

WebUI.setText(findTestObject('Web/GeoServer/Page_GeoServer Users Groups and Rol/input_password'), 'geoserver')
...
WebUI.click(findTestObject('Web/GeoServer/Page_GeoServer Users Groups and Rol/input_services0panelgroupstabl'))

WebUI.click(findTestObject('Web/GeoServer/Page_GeoServer Users Groups and Rol/input_services0panelgroupstabl_1'))
