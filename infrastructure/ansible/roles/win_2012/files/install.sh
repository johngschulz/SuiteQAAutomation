...
"/cygdrive/c/Program Files (x86)/Apache Software Foundation/Tomcat 8.0/bin/Tomcat8.exe" //US//Tomcat8  ++JvmOptions="-Xbootclasspath/a:C:\Program Files (x86)\Boundless\suite\geoserver\marlin\marlin-0.7.3-Unsafe.jar"
...
"/cygdrive/c/Program Files (x86)/Apache Software Foundation/Tomcat 8.0/bin/Tomcat8.exe" //US//Tomcat8  ++JvmOptions="-Djava.library.path=C:\Program Files (x86)\Boundless\suite\geoserver\gdal\';'C:\Program Files (x86)\netCDF 4.4.0\bin';'C:\libjpeg-turbo\bin"
...
"/cygdrive/c/Program Files (x86)/Apache Software Foundation/Tomcat 8.0/bin/Tomcat8.exe" //US//Tomcat8  ++JvmOptions="-XX:SoftRefLRUPolicyMSPerMB=36000"
